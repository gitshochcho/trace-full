                        ...
                        <div class="card card-outline card-primary">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    @php $selectedTeamMembers = old('team_members', []); @endphp
                                    <div class="col-12">
                                    ...
                                    @php $selectedRelatedProjects = old('related_projects', []); @endphp
                                    <div class="col-12">
                                    ...
                                    @php $selectedRelatedInsights = old('related_insights', []); @endphp
                                    <div class="col-12">
