...
@section('content')
    @php
        ...
        $selectedInsights = old('related_insights', []);
        $selectedExperts  = old('experts', []);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function wireTagPicker(containerId, hiddenInputsId, tagClass, inputName) {
        ...
        function renumber() {
            ...
            Array.from(hidden.querySelectorAll('input')).forEach(function (inp, index) {
                const tag = container.querySelector('.' + tagClass + '[data-id="' + inp.value + '"]');
                if (!tag) return;
